...
function renderSuperAdminDashboard(){
  ...
  function saLayout(){
    ...
    API.layout.get().then(data=>{
      ...
      const SLABELS={coaching:'🤖 Coaching',feedback:'💬 Feedback',goals:'🎯 Goals',stats:'📊 Stats',branding:'✨ Branding',ai:'🤖 AI Insights',team:'🏆 Team',staff:'👥 Staff',links:'🔗 Links',estimator:'📈 Estimator',settings:'⚙️ Settings',branding2:'🎨 Branding',analytics:'📈 Analytics',analytics:'📈 Analytics'};
